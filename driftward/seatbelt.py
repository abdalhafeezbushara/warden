"""Compile a Driftward Policy into a macOS Seatbelt (SBPL) profile.
...
Driftward does NOT try to express per-host rules in Seatbelt. Instead the profile
permits localhost (so tools can reach the Driftward egress proxy) and the proxy
...
def compile_profile(policy: Policy, proxy_port: int | None = None,
    ...
    lines: list[str] = [
        "(version 1)",
        ";; Generated by Driftward. Do not edit by hand.",
    ...
    if policy.network.deny_all_other:
        # Pin egress to the Driftward proxy ONLY — a single loopback port. This
